...
#include "backend/include/search_algorithm.hpp" // Incluir el header del archivo de búsqueda
                                                ...
                                                // Una idea: Podriamos buscar las peliculas solicitando 2 cosas: Una frase del titulo y tag 
                                                // Asi podriamos limitar el procesamiento de los datos y buscar solo en las peliculas de terror por ejemplo 
                                                ...
                                                */
int main(){
    //Declaracion de la clase administradora 
    //Declaracion de las clases que van a ser utilizadas
    //Ademas las clases necesarias para el frontend
    //Codigo dentro de una estructura frontend
    //Donde podria estar la clase proxy? Primero leeriamos el inicio de sesion
    std::string frase_busqueda; 
    while (std::getline(std::cin, frase_busqueda))
    {
